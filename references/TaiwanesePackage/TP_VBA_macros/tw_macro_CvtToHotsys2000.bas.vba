Attribute VB_Name = "CvtToHotsys2000"
Option Explicit
...
Sub CvtToHotsys2000()
    ...
    If MsgBox("To convert Taiwanese Package to Hotsys 2000?", vbYesNo) <> vbYes Then
        Exit Sub
    End If


    Application.Caption = "Converting Taiwanese Package to Hotsys 2000. Please wait..."

...
Sub CvtHotsys98()
    ...
    tai = tai + ChrW$(176) + ChrW$(243)

     
    If MsgBox("To convert Hotsys 95/98 to Taiwanese Package?", vbYesNo) <> vbYes Then
        Exit Sub
    End If


    Application.Caption = "Converting Hotsys 95/98 to Taiwanese Package. Please wait..."
